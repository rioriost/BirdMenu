...
BirdMenuは、INKBIRD ITH-11-B Bluetooth Low Energy温湿度計の値を表示するmacOSメニューバーアプリです。
...
BirdMenuは、近くにあるINKBIRD ITH-11-Bデバイスから次のデータを処理する場合があります。
...
BirdMenuは、INKBIRD ITH-11-Bデバイスを検出し通信するためにBluetoothアクセスを要求します。
